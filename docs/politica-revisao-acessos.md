## POL-SEG-003 – Política de Revisão Periódica de Acessos
...
Estão incluídos no escopo, entre outros:

- Ambientes Microsoft 365, incluindo Exchange Online e SharePoint;

- Repositórios de arquivos corporativos;

- Sistemas utilizados para gestão e auditoria de TI (ex.: GLPI);

- Contas administrativas e contas de emergência (Break Glass).
...
- Extraordinariamente, sempre que ocorrer:
  ...
  - determinação da Direção ou da área de TI.
